...
def format_lists():
    return (
        ...
        "وَأَمَّا مَا فَرَضَهُ عَلَى الأذنين: فَالإِشْتِمَاعُ إِلَى ذِكْرِ الله تَعَالَى وَالإِنصَاتُ لِمَا يُتْلَى مِنْ كِتَابِهِ، وَتَرْكُ الإصْغَاءِ لِمَا يُسْخِطُهُ، فَقَالَ سُبْحَانَهُ: "
